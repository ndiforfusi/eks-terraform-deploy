pipeline {
    ...
    stages {
        ...
        stage ('5. Email Notification') {
            steps {
               mail bcc: 'cliffeg1@gmail.com', body: '''Terraform deployment is completed.
               Let me know if the changes look okay.
               Thanks,
               Dominion System Technologies,
              +1 (416) 312-7624''', cc: 'cliffeg1@gmail.com', from: '', replyTo: '', subject: 'Terraform Infra deployment completed!!!', to: 'cliffeg1@gmail.com'
